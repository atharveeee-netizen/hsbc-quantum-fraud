...
* **Quantum Advantage Was Not Demonstrated:** On matched real escalated transactions, Projected Quantum Kernel (PR-AUC = 0.5540) versus Tuned Classical RBF (PR-AUC = 0.6561) yielded $\Delta\text{PR-AUC} = -0.1021$ with a **95% bootstrap confidence interval of $[-0.0383, +0.1821]$** and $p = 0.246$ (Bonferroni $p = 0.492$). Because the confidence interval spans zero and $p > 0.05$, the null hypothesis cannot be rejected.
* **Geometric Equivalence:** Centered Kernel Alignment (CKA) between the quantum kernel and Classical RBF is **0.5741**, showing the quantum feature map closely reproduces classical RBF metric geometry rather than creating an orthogonal space.
...
| **Classical RBF Control** | Real (IEEE-CIS) | PR-AUC (Matched $N=200$) | **0.6561** (ROC-AUC: **0.7546**) | `[MEASURED]` | [`real_quantum_matched_experiment.json`](file:///C:/Users/noobg/.gemini/antigravity-ide/scratch/hsbc-quantum-fraud/docs/evidence/real_quantum_matched_experiment.json) |
| **Quantum Projected (PQK)** | Real (IEEE-CIS) | PR-AUC (Matched $N=200$) | **0.5540** (ROC-AUC: **0.6753**) | `[MEASURED]` | [`real_quantum_matched_experiment.json`](file:///C:/Users/noobg/.gemini/antigravity-ide/scratch/hsbc-quantum-fraud/docs/evidence/real_quantum_matched_experiment.json) |
| **Quantum − RBF Delta** | Real (IEEE-CIS) | $\Delta\text{PR-AUC}$ (Bootstrap) | **-0.1021** ($95\%\text{ CI: } [-0.0383, +0.1821]$) | `[MEASURED]` | [`real_quantum_matched_experiment.json`](file:///C:/Users/noobg/.gemini/antigravity-ide/scratch/hsbc-quantum-fraud/docs/evidence/real_quantum_matched_experiment.json) |
...
| **Quantum Geometry** | Real (IEEE-CIS) | Centered Kernel Alignment | **0.5741** (PQK vs RBF), **0.9373** (Fidelity vs RBF) | `[MEASURED]` | [`real_quantum_geometry.json`](file:///C:/Users/noobg/.gemini/antigravity-ide/scratch/hsbc-quantum-fraud/docs/evidence/real_quantum_geometry.json) |
