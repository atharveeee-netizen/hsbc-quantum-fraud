...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **Classical RBF Control (Tuned)** | Kernel Support Vector Machine | **0.3367** | **0.4652** | **0.3034** | **0.015 ms** | Sub-millisecond local CPU | `[MEASURED]` |
...
| **Projected Quantum Kernel (PQK)** | 1-Qubit Pauli Expectations + RBF | **0.4043** | **0.5171** | **0.3017** | **22.1 ms (Sim)** | $O(N)$ state projections | `[MEASURED]` |
...
1. **Nominal Differences:**  
   Projected Quantum Kernel achieved a nominal PR-AUC of 0.4043 vs 0.3367 for Classical RBF ($\Delta = +0.0676$).
