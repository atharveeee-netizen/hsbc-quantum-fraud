...
- **Classical Controls (N=200):** Tuned RBF PR-AUC = 0.3367; MLP = 0.3516; GBM = 0.3529.
- **Quantum Kernels (N=200):** Fidelity Kernel = 0.3789; Projected Quantum Kernel (PQK) = 0.4043.
- **Paired Bootstrap Test (PQK vs RBF):** Delta PR-AUC = +0.0653, 95% CI = [-0.0383, +0.1821], p = 0.246 (Bonferroni p = 0.492). Null hypothesis not rejected.
- **Geometric Alignment:** Centered Kernel Alignment (CKA) between PQK and RBF is 0.9337.
