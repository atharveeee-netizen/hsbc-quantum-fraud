...
| **NL-19** | `0.6561` | Classical RBF PR-AUC | `real_quantum_matched_experiment.json` | IEEE-CIS Escalated Support | Matched N=200 | `[REAL DATA] [MEASURED]` | "PR-AUC of 0.6561 for tuned Classical RBF baseline" | "Weak classical baseline" |
...
| **NL-23** | `0.5540` | Projected Quantum Kernel PR-AUC | `real_quantum_matched_experiment.json` | IEEE-CIS Escalated Support | Matched N=200 | `[REAL DATA] [MEASURED]` | "nominal PR-AUC of 0.5540 for Projected Quantum Kernel" | "Unqualified claims of quantum victory or superiority" |
| **NL-24** | `-0.1021` | Point estimate delta (PQK - RBF) | `real_quantum_matched_experiment.json` | IEEE-CIS Escalated Support | Matched N=200 | `[REAL DATA] [MEASURED]` | "nominal point-estimate delta of -0.1021" | "Statistically significant quantum margin" |
...
| **NL-27** | `0.5741` | CKA (PQK vs Classical RBF) | `real_quantum_geometry.json` | IEEE-CIS Escalated Support | Matched N=200 | `[REAL DATA] [MEASURED]` | "Centered Kernel Alignment of 0.5741, showing strong geometric alignment" | "Proves quantum and classical equivalence" |
